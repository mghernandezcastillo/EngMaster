...
export const lessons: Lesson[] = [
  {
    ...
    "vocabulary": [
      {
        ...
        "meaning": "convertirse gradualmente en / adaptarse a",
        "microExample": "I grew into the role over time.",
        "microExampleTranslation": "Con el tiempo me adapté al cargo."
      },
      {
        "expression": "take on",
        "meaning": "asumir una responsabilidad o reto",
        "microExample": "She took on a demanding project.",
        "microExampleTranslation": "Ella asumió un proyecto exigente."
      },
      {
        "expression": "look back on",
        "meaning": "recordar y reflexionar sobre el pasado",
        "microExample": "I look back on that period with gratitude.",
      ...
      },
      {
        ...
        "microExampleTranslation": "Él acumuló experiencia valiosa."
      },
      {
        "expression": "stand out",
        "meaning": "destacarse",
        "microExample": "Her ability to listen made her stand out.",
        "microExampleTranslation": "Su capacidad de escuchar la hizo destacar."
      },
      {
        "expression": "move forward",
        "meaning": "avanzar después de una situación",
        "microExample": "We learned from it and moved forward.",
        "microExampleTranslation": "Aprendimos de eso y seguimos adelante."
      },
      {
        "expression": "find your feet",
        "meaning": "adaptarse y comenzar a sentirse seguro",
        "microExample": "It took me a few weeks to find my feet.",
        "microExampleTranslation": "Me tomó unas semanas adaptarme y sentirme seguro."
      },
      {
        "expression": "a steep learning curve",
        "meaning": "un proceso de aprendizaje rápido y difícil",
        "microExample": "Managing a team was a steep learning curve.",
        "microExampleTranslation": "Dirigir un equipo fue un aprendizaje intenso y exigente."
      }
    ],
    "collocations": [
    ...
    "structures": [
      ...
      "It was only when ___ that I understood ___.",
  ...
  },
  {
    ...
    "vocabulary": [
      {
        ...
        "meaning": "manejar o enfrentar una situación",
        "microExample": "We dealt with the issue calmly.",
      ...
      },
      {
        ...
        "microExampleTranslation": "Ella se recuperó después del rechazo."
      },
      {
        "expression": "work through",
        "meaning": "resolver algo paso a paso",
        "microExample": "We worked through the problem together.",
        "microExampleTranslation": "Resolvimos el problema paso a paso."
      },
      {
        "expression": "get over",
      ...
      },
      {
        ...
        "meaning": "cambiar una situación negativa",
        "microExample": "The new plan turned the situation around.",
        "microExampleTranslation": "El nuevo plan cambió la situación por completo."
      },
      {
        "expression": "learn from",
        "meaning": "aprender a partir de una experiencia",
        "microExample": "Strong teams learn from their mistakes.",
        "microExampleTranslation": "Los equipos sólidos aprenden de sus errores."
      },
      {
        "expression": "a blessing in disguise",
        "meaning": "algo negativo que termina produciendo un beneficio",
        "microExample": "Losing that opportunity was a blessing in disguise.",
        "microExampleTranslation": "Perder esa oportunidad terminó siendo algo positivo."
      },
      {
        "expression": "get back on track",
        "meaning": "retomar el rumbo correcto",
        "microExample": "The review helped us get back on track.",
        "microExampleTranslation": "La revisión nos ayudó a retomar el rumbo."
      }
    ],
    "collocations": [
      "setback",
    ...
    "structures": [
      ...
      "Rather than ___, I chose to ___.",
      "No matter how ___, ___."
    ]
  },
  {
    "id": "lesson-3",
    ...
    "vocabulary": [
      {
        "expression": "weigh up",
        "meaning": "evaluar ventajas y desventajas",
        "microExample": "We weighed up the available options.",
        "microExampleTranslation": "Evaluamos las opciones disponibles."
      },
      {
        "expression": "rule out",
        "meaning": "descartar una posibilidad",
        "microExample": "We cannot rule out further delays.",
        "microExampleTranslation": "No podemos descartar más retrasos."
      },
      {
        "expression": "go ahead with",
        "meaning": "proceder con un plan",
        "microExample": "They went ahead with the proposal.",
        "microExampleTranslation": "Siguieron adelante con la propuesta."
      },
      {
        "expression": "think through",
        "meaning": "analizar cuidadosamente",
        "microExample": "Think the consequences through first.",
      ...
      },
      {
        ...
        "microExampleTranslation": "Podemos recurrir al plan original."
      },
      {
        "expression": "hold off",
        "meaning": "esperar antes de actuar",
        "microExample": "I decided to hold off until Friday.",
        "microExampleTranslation": "Decidí esperar hasta el viernes."
      },
      {
        "expression": "sit on the fence",
        "meaning": "evitar tomar una posición o decisión",
        "microExample": "You cannot sit on the fence forever.",
        "microExampleTranslation": "No puedes evitar decidir para siempre."
      },
      {
        "expression": "take the plunge",
        "meaning": "decidirse a hacer algo importante o arriesgado",
        "microExample": "After months of planning, she took the plunge.",
        "microExampleTranslation": "Después de meses de planeación, finalmente se decidió."
      }
    ],
    "collocations": [
      "trade-off",
    ...
    "structures": [
      "Much as I would like to ___, ___.",
      "The more carefully we ___, the less likely we are to ___.",
  ...
  },
  {
    ...
    "vocabulary": [
      {
        "expression": "step up",
        "meaning": "asumir responsabilidad cuando se necesita",
        "microExample": "She stepped up during the crisis.",
      ...
      },
      {
        ...
        "meaning": "entregar responsabilidad o control",
        "microExample": "He handed the task over to his colleague.",
        "microExampleTranslation": "Él le entregó la tarea a su colega."
      },
      {
        "expression": "bring out",
        "meaning": "hacer que una cualidad aparezca",
        "microExample": "The coach brought out the best in the team.",
        "microExampleTranslation": "El entrenador sacó lo mejor del equipo."
      },
      {
        "expression": "set out",
        "meaning": "explicar o presentar claramente un plan",
        "microExample": "She set out the priorities clearly.",
        "microExampleTranslation": "Ella expuso claramente las prioridades."
      },
      {
        "expression": "take over",
        "meaning": "asumir control o responsabilidad",
        "microExample": "I took over the project in May.",
        "microExampleTranslation": "Asumí el proyecto en mayo."
      },
      {
        "expression": "lead by example",
        "meaning": "guiar mediante la propia conducta",
        "microExample": "Managers should lead by example.",
        "microExampleTranslation": "Los gerentes deben liderar con el ejemplo."
      },
      {
        "expression": "go the extra mile",
        "meaning": "hacer un esfuerzo adicional",
        "microExample": "The team went the extra mile for the client.",
        "microExampleTranslation": "El equipo hizo un esfuerzo adicional por el cliente."
      }
    ],
    "collocations": [
      "accountability",
    ...
    "structures": [
      "A leader is not someone who ___, but someone who ___.",
      "Unless expectations are ___, ___.",
      "By ___ing, we can ___."
    ]
  },
  {
    "id": "lesson-5",
    ...
    "vocabulary": [
      {
        "expression": "bring up",
        "meaning": "mencionar un tema",
        "microExample": "She brought up an important concern.",
        "microExampleTranslation": "Ella mencionó una preocupación importante."
      },
      {
        "expression": "point out",
        "meaning": "señalar o hacer notar",
        "microExample": "He pointed out a flaw in the plan.",
        "microExampleTranslation": "Él señaló una falla en el plan."
      },
      {
        "expression": "get across",
        "meaning": "comunicar una idea con éxito",
        "microExample": "I struggled to get my point across.",
        "microExampleTranslation": "Me costó comunicar mi idea."
      },
      {
        "expression": "back down",
        "meaning": "ceder o retirar una posición",
        "microExample": "Neither side was willing to back down.",
        "microExampleTranslation": "Ninguna parte estaba dispuesta a ceder."
      },
      {
        "expression": "speak up",
        "meaning": "expresar una opinión con firmeza",
        "microExample": "You should speak up if something is unsafe.",
        "microExampleTranslation": "Debes expresar tu opinión si algo no es seguro."
      },
      {
        "expression": "clear up",
        "meaning": "aclarar una confusión",
        "microExample": "The meeting cleared up the misunderstanding.",
        "microExampleTranslation": "La reunión aclaró el malentendido."
      },
      {
        "expression": "see eye to eye",
        "meaning": "estar completamente de acuerdo",
        "microExample": "We do not always see eye to eye.",
        "microExampleTranslation": "No siempre estamos de acuerdo."
      },
      {
        "expression": "meet someone halfway",
        "meaning": "ceder parcialmente para llegar a un acuerdo",
        "microExample": "Both sides need to meet halfway.",
        "microExampleTranslation": "Ambas partes deben ceder un poco."
      }
    ],
    "collocations": [
    ...
    "structures": [
      "While it may be true that ___, ___.",
      "What matters is not ___, but ___.",
      "I can see where you are coming from, yet ___."
    ]
  },
  {
    "id": "lesson-6",
    ...
    "vocabulary": [
      {
        "expression": "rely on",
        "meaning": "depender de",
        "microExample": "We rely on technology every day.",
        "microExampleTranslation": "Dependemos de la tecnología todos los días."
      },
      {
        "expression": "cut down on",
        "meaning": "reducir el consumo o uso",
        "microExample": "I am trying to cut down on screen time.",
        "microExampleTranslation": "Estoy intentando reducir el tiempo de pantalla."
      },
      {
        "expression": "keep up with",
        "meaning": "mantenerse al día con",
        "microExample": "It is hard to keep up with every update.",
        "microExampleTranslation": "Es difícil mantenerse al día con cada actualización."
      },
      {
        "expression": "phase out",
        "meaning": "eliminar gradualmente",
        "microExample": "The company phased out the old system.",
        "microExampleTranslation": "La empresa eliminó gradualmente el sistema antiguo."
      },
      {
        "expression": "switch off",
        "meaning": "desconectarse o apagar",
        "microExample": "I switch off notifications after work.",
        "microExampleTranslation": "Desactivo las notificaciones después del trabajo."
      },
      {
        "expression": "opt out of",
        "meaning": "decidir no participar",
        "microExample": "Users can opt out of data collection.",
        "microExampleTranslation": "Los usuarios pueden decidir no participar en la recolección de datos."
      },
      {
        "expression": "a double-edged sword",
        "meaning": "algo con ventajas y desventajas",
        "microExample": "Automation can be a double-edged sword.",
        "microExampleTranslation": "La automatización puede tener beneficios y riesgos."
      },
      {
        "expression": "at your fingertips",
        "meaning": "disponible de inmediato",
        "microExample": "A vast amount of information is at our fingertips.",
        "microExampleTranslation": "Tenemos una enorme cantidad de información al alcance."
      }
    ],
    "collocations": [
      "convenience",
    ...
    "structures": [
      "The extent to which ___ depends on ___.",
      "Not until I ___ did I realize ___.",
      "Whether ___ is beneficial depends largely on ___."
    ]
  },
  {
    "id": "lesson-7",
    ...
    "vocabulary": [
      {
        "expression": "pick up",
        "meaning": "aprender de manera informal",
        "microExample": "I picked up the expression from a podcast.",
        "microExampleTranslation": "Aprendí la expresión escuchando un pódcast."
      },
      {
        "expression": "brush up on",
        "meaning": "repasar una habilidad que ya se tenía",
        "microExample": "I need to brush up on my grammar.",
        "microExampleTranslation": "Necesito repasar mi gramática."
      },
      {
        "expression": "take in",
        "meaning": "comprender y asimilar información",
        "microExample": "There was too much information to take in.",
        "microExampleTranslation": "Había demasiada información para asimilar."
      },
      {
        "expression": "go over",
        "meaning": "revisar de nuevo",
        "microExample": "Let us go over the main points.",
        "microExampleTranslation": "Revisemos nuevamente los puntos principales."
      },
      {
        "expression": "put into practice",
        "meaning": "poner en práctica",
        "microExample": "You must put the new vocabulary into practice.",
        "microExampleTranslation": "Debes poner en práctica el vocabulario nuevo."
      },
      {
        "expression": "keep at",
        "meaning": "continuar a pesar de la dificultad",
        "microExample": "Keep at it even when progress feels slow.",
        "microExampleTranslation": "Continúa aunque el progreso parezca lento."
      },
      {
        "expression": "learn the ropes",
        "meaning": "aprender cómo funciona una actividad",
        "microExample": "It took time to learn the ropes.",
        "microExampleTranslation": "Tomó tiempo aprender cómo funcionaba todo."
      },
      {
        "expression": "become second nature",
        "meaning": "volverse automático y natural",
        "microExample": "With practice, the structure became second nature.",
        "microExampleTranslation": "Con práctica, la estructura se volvió natural."
      }
    ],
    "collocations": [
      "retention",
    ...
    "structures": [
      "The reason why ___ is that ___.",
      "Having ___, I was able to ___.",
      "It is through ___ that we ___."
    ]
  },
  {
    "id": "lesson-8",
    ...
    "vocabulary": [
      {
        ...
        "meaning": "dejar de funcionar; fracasar la comunicación",
        "microExample": "Communication broke down under pressure.",
        "microExampleTranslation": "La comunicación falló bajo presión."
      },
      {
        "expression": "leave out",
        "meaning": "omitir información",
        "microExample": "Do not leave out the key details.",
        "microExampleTranslation": "No omitas los detalles clave."
      },
      {
        "expression": "read into",
        "meaning": "interpretar más de lo que realmente se dijo",
        "microExample": "You may be reading too much into the message.",
        "microExampleTranslation": "Tal vez estás interpretando demasiado el mensaje."
      },
      {
        "expression": "talk over",
        "meaning": "conversar para analizar un problema",
        "microExample": "We should talk the issue over.",
        "microExampleTranslation": "Deberíamos conversar para analizar el problema."
      },
      {
        "expression": "reach out",
        "meaning": "contactar a alguien",
        "microExample": "I reached out to clarify the request.",
        "microExampleTranslation": "Me comuniqué para aclarar la solicitud."
      },
      {
        "expression": "get through to",
        "meaning": "lograr que alguien comprenda",
        "microExample": "I could not get through to him.",
        "microExampleTranslation": "No logré hacerle entender mi punto."
      },
      {
        "expression": "read between the lines",
        "meaning": "entender un significado implícito",
        "microExample": "You have to read between the lines.",
        "microExampleTranslation": "Hay que entender lo que se insinúa."
      },
      {
        "expression": "get your wires crossed",
        "meaning": "confundirse por un malentendido",
        "microExample": "We got our wires crossed about the deadline.",
        "microExampleTranslation": "Nos confundimos con respecto a la fecha límite."
      }
    ],
    "collocations": [
      "ambiguity",
    ...
    "structures": [
      "What may sound ___ can be interpreted as ___.",
      "If something is left unclear, ___.",
      "Only by ___ing can we ___."
    ]
  },
  {
    "id": "lesson-9",
    ...
    "vocabulary": [
      {
        "expression": "put off",
        "meaning": "posponer",
        "microExample": "I kept putting off the difficult task.",
        "microExampleTranslation": "Seguí posponiendo la tarea difícil."
      },
      {
        "expression": "catch up on",
        "meaning": "ponerse al día con",
        "microExample": "I used Saturday to catch up on emails.",
        "microExampleTranslation": "Usé el sábado para ponerme al día con los correos."
      },
      {
        "expression": "run out of",
        "meaning": "quedarse sin",
        "microExample": "We ran out of time before the deadline.",
        "microExampleTranslation": "Nos quedamos sin tiempo antes de la fecha límite."
      },
      {
        "expression": "set aside",
        "meaning": "reservar tiempo o recursos",
        "microExample": "Set aside an hour for focused work.",
        "microExampleTranslation": "Reserva una hora para trabajar con concentración."
      },
      {
        "expression": "cut back on",
        "meaning": "reducir",
        "microExample": "I cut back on unnecessary meetings.",
        "microExampleTranslation": "Reduje las reuniones innecesarias."
      },
      {
        "expression": "wind down",
        "meaning": "relajarse gradualmente",
        "microExample": "I need time to wind down in the evening.",
        "microExampleTranslation": "Necesito tiempo para relajarme en la noche."
      },
      {
        "expression": "burn the candle at both ends",
        "meaning": "exigirse demasiado sin descansar",
        "microExample": "You cannot burn the candle at both ends indefinitely.",
        "microExampleTranslation": "No puedes exigirte al máximo sin descansar indefinidamente."
      },
      {
        "expression": "put something on the back burner",
        "meaning": "dejar algo temporalmente en segundo plano",
        "microExample": "We put the redesign on the back burner.",
        "microExampleTranslation": "Dejamos el rediseño temporalmente en segundo plano."
      }
    ],
    "collocations": [
      "competing demands",
    ...
    "structures": [
      "There is little point in ___ing if ___.",
      "Even if ___, it does not necessarily mean ___.",
      "The sooner we ___, the easier it becomes to ___."
    ]
  },
  {
    "id": "lesson-10",
    ...
    "vocabulary": [
      {
        ...
        "meaning": "ocurrir o surgir",
        "microExample": "How did the change come about?",
        "microExampleTranslation": "¿Cómo surgió el cambio?"
      },
      {
        "expression": "bring about",
        "meaning": "provocar un cambio",
        "microExample": "The policy brought about major improvements.",
        "microExampleTranslation": "La política produjo mejoras importantes."
      },
      {
        "expression": "shake up",
        "meaning": "cambiar drásticamente una situación",
        "microExample": "The new technology shook up the industry.",
        "microExampleTranslation": "La nueva tecnología transformó la industria."
      },
      {
        "expression": "settle into",
        "meaning": "adaptarse gradualmente a una situación",
        "microExample": "I settled into the new routine.",
        "microExampleTranslation": "Me adapté a la nueva rutina."
      },
      {
        "expression": "branch out",
        "meaning": "ampliarse hacia nuevas áreas",
        "microExample": "The company branched out into training.",
        "microExampleTranslation": "La empresa se expandió hacia la capacitación."
      },
      {
        "expression": "let go of",
        "meaning": "dejar atrás o soltar",
        "microExample": "We need to let go of outdated assumptions.",
        "microExampleTranslation": "Debemos dejar atrás suposiciones anticuadas."
      },
      {
        "expression": "turn over a new leaf",
        "meaning": "comenzar de nuevo con mejores hábitos",
        "microExample": "He decided to turn over a new leaf.",
        "microExampleTranslation": "Decidió comenzar una nueva etapa con mejores hábitos."
      },
      {
        "expression": "out of your comfort zone",
        "meaning": "fuera de lo conocido y cómodo",
        "microExample": "Growth often happens outside your comfort zone.",
        "microExampleTranslation": "El crecimiento suele ocurrir fuera de la zona de confort."
      }
    ],
    "collocations": [
      "adaptability",
    ...
    "structures": [
      "Change rarely happens because ___ alone.",
      "Far from being ___, it can be ___.",
      "Once people begin to ___, ___."
    ]
  },
  {
    "id": "lesson-11",
    ...
    "vocabulary": [
      {
        ...
        "meaning": "investigar",
        "microExample": "We need to look into the claim.",
        "microExampleTranslation": "Necesitamos investigar la afirmación."
      },
      {
        "expression": "make out",
        "meaning": "distinguir o comprender con dificultad",
        "microExample": "I could not make out the source in the image.",
        "microExampleTranslation": "No pude distinguir la fuente en la imagen."
      },
      {
        "expression": "sift through",
        "meaning": "revisar mucha información cuidadosamente",
        "microExample": "She sifted through the available evidence.",
        "microExampleTranslation": "Ella revisó cuidadosamente la evidencia disponible."
      },
      {
        "expression": "call out",
        "meaning": "señalar públicamente algo incorrecto",
        "microExample": "Experts called out the misleading statistic.",
        "microExampleTranslation": "Los expertos señalaron la estadística engañosa."
      },
      {
        "expression": "cover up",
        "meaning": "ocultar deliberadamente",
        "microExample": "The report exposed an attempt to cover up the error.",
        "microExampleTranslation": "El informe reveló un intento de ocultar el error."
      },
      {
        "expression": "boil down to",
        "meaning": "reducirse esencialmente a",
        "microExample": "The debate boils down to trust.",
        "microExampleTranslation": "El debate se reduce esencialmente a la confianza."
      },
      {
        "expression": "take something at face value",
        "meaning": "aceptar algo sin cuestionarlo",
        "microExample": "Do not take the headline at face value.",
        "microExampleTranslation": "No aceptes el titular sin cuestionarlo."
      },
      {
        "expression": "the tip of the iceberg",
        "meaning": "una pequeña parte de un problema mayor",
        "microExample": "The visible errors were only the tip of the iceberg.",
        "microExampleTranslation": "Los errores visibles eran solo una pequeña parte del problema."
      }
    ],
    "collocations": [
      "credible source",
    ...
    "structures": [
      "Just because ___ does not mean ___.",
      "The claim that ___ overlooks ___.",
      "What appears to be ___ may in fact be ___."
    ]
  },
  {
    "id": "lesson-12",
    ...
    "vocabulary": [
      {
        "expression": "aim for",
        "meaning": "tener como objetivo",
        "microExample": "We should aim for steady improvement.",
        "microExampleTranslation": "Debemos aspirar a una mejora constante."
      },
      {
        "expression": "live up to",
        "meaning": "estar a la altura de una expectativa",
        "microExample": "The experience lived up to my expectations.",
        "microExampleTranslation": "La experiencia estuvo a la altura de mis expectativas."
      },
      {
        "expression": "map out",
        "meaning": "planificar detalladamente",
        "microExample": "She mapped out the next stage of her career.",
        "microExampleTranslation": "Ella trazó la siguiente etapa de su carrera."
      },
      {
        "expression": "carry on",
        "meaning": "continuar",
        "microExample": "We carried on despite the uncertainty.",
        "microExampleTranslation": "Continuamos a pesar de la incertidumbre."
      },
      {
        "expression": "give back",
        "meaning": "contribuir o devolver a la comunidad",
        "microExample": "He wants to give back through education.",
        "microExampleTranslation": "Él quiere contribuir mediante la educación."
      },
      {
        "expression": "see through",
        "meaning": "llevar algo hasta el final",
        "microExample": "I intend to see the project through.",
        "microExampleTranslation": "Tengo la intención de llevar el proyecto hasta el final."
      },
      {
        "expression": "the bigger picture",
        "meaning": "la visión general",
        "microExample": "Do not lose sight of the bigger picture.",
        "microExampleTranslation": "No pierdas de vista la visión general."
      },
      {
        "expression": "stand the test of time",
        "meaning": "seguir siendo valioso con el paso del tiempo",
        "microExample": "Good principles stand the test of time.",
        "microExampleTranslation": "Los buenos principios conservan su valor con el tiempo."
      },
      {
        "expression": "at the end of the day",
        "meaning": "en definitiva",
        "microExample": "At the end of the day, the choice is yours.",
        "microExampleTranslation": "En definitiva, la decisión es tuya."
      }
    ],
    "collocations": [
      "fulfillment",
    ...
    "structures": [
      ...
      "Whatever path we choose, ___.",
      "If I were to define ___, I would say ___."
    ]
  }
];
