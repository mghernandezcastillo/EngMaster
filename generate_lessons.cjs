...
const lessonsData = [
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { expression: 'follow through', meaning: 'cumplir completamente lo prometido', microExample: 'Good leaders follow through on commitments.', microExampleTranslation: 'Los buenos líderes cumplen sus compromisos.' },
